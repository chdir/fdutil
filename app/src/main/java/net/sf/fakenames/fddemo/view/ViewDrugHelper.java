...
public class ViewDrugHelper {
     ...
     */
    public static ViewDrugHelper create(ViewGroup forParent, Callback cb) {
        return new ViewDrugHelper(forParent.getContext(), forParent, cb);
    }

    public static ViewDrugHelper create(ViewGroup forParent, Callback cb, Interpolator interpolator) {
        return new ViewDrugHelper(forParent.getContext(), forParent, cb, interpolator);
    }

    public static ViewDrugHelper create(ViewGroup forParent, float sensitivity, Callback cb, Interpolator interpolator) {
        final ViewDrugHelper helper = create(forParent, cb, interpolator);
     ...
     * @return a new ViewDragHelper instance
     */
    public static ViewDrugHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
        final ViewDrugHelper helper = create(forParent, cb);
        helper.mTouchSlop = (int) (helper.mTouchSlop * (1 / sensitivity));
        return helper;
    }
     ...
     * @param forParent Parent view to monitor
     */
    private ViewDrugHelper(Context context, ViewGroup forParent, Callback cb) {
        this(context, forParent, cb, sInterpolator);
    }

    private ViewDrugHelper(Context context, ViewGroup forParent, Callback cb, Interpolator interpolator) {
        if (forParent == null) {

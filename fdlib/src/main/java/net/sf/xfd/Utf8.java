...
public final class Utf8 {
    ...
    private static long intSize(String string, int beginIndex, int endIndex) {
        int result = 0;
    ...
    private static long longSize(String string, int beginIndex, int endIndex) {
        long result = 0;
        for (int i = beginIndex; i < endIndex;) {
            int c = string.charAt(i);
    ...
    public static long size(String string, int beginIndex, int endIndex) {
        ...
        final long length = endIndex - beginIndex;

        if (length * 3 / 2 < Integer.MAX_VALUE) {
            return intSize(string, 0, endIndex);
        } else {
            return longSize(string, 0, endIndex);
        }
    }
}
